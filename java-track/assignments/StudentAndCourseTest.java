...
public class StudentAndCourseTest extends TestCase {
	...
	public void testgetAllCourses() {
		Course.courseList = new ArrayList<Course>();
		Course b = new Course("Course101", 3, 4);
		Course d = new Course("Course102", 5, 6);

		ArrayList<Course> bList = Course.getAllCourses();
		assertEquals("number of courses in getallcourses isn't correct", 2, bList.size());
		assertEquals("first course name doesn't match", "Course101", bList.get(0).getName());
		assertEquals("second course name doesn't match", "Course102", bList.get(1).getName());
	}
